...
class Shape extends Component {
    constructor(graphics) {
        ...
        this._permission = false; // 允许触发mousemove和mouseup
     ...
     * @private
     */
    _onFabricMouseDownByControl(control) {
     ...
     * @private
     */
    _onFabricMouseMoveByControl(control) {
     ...
     * @private
     */
    _onFabricMouseUpByControl(control) {
        if (!this._permission) return;
        const canvas = this.getCanvas();
        const startPointX = this._startPoint.x;
        const startPointY = this._startPoint.y;
